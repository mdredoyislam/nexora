...
const VERIFICATIONS = [
  { date: "24-08-2021 3:04 PM", user: "Kyla watson", documentType: "Utility Bill", status: "Pending" },
  { date: "23-08-2021 3:04 PM", user: "Irish watson", documentType: "Bank Statement", status: "Approved" },
];
...
export default function AdminAddressVerificationsPage() {
  const [search, setSearch] = useState("");

  const filtered = VERIFICATIONS.filter(v =>
    `${v.user} ${v.documentType}`.toLowerCase().includes(search.toLowerCase())
  );
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="bg-[#1a1b26] border border-white/5 rounded-xl overflow-hidden">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between p-5 border-b border-white/5 gap-4">
          <h2 className="text-lg font-bold text-white">All Address Verifications</h2>
            ...
            <tbody className="divide-y divide-white/5">
              {filtered.map((v, i) => (
                <tr key={i} className="hover:bg-white/5 transition-colors">
                  ...
                  <td className="px-5 py-4 text-gray-300">{v.documentType}</td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-[#1a1b26] border border-white/10 rounded-2xl w-full max-w-lg shadow-2xl animate-in fade-in zoom-in duration-200">
            <div className="flex items-center justify-between p-6 border-b border-white/5">
              <h2 className="text-lg font-bold text-white">Verification Details</h2>
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white font-medium">{itemToView.documentType}</p>
                </div>
                <div>
